...
<h3 style="color:#f1f5f9;font-size:20px;margin-bottom:8px;">&#128465; Sedang Menghapus Voucher</h3>
...
<div style="display:inline-block;background:#0f172a;color:#f87171;font-size:28px;font-weight:700;padding:8px 24px;border-radius:8px;margin-bottom:8px;">' . $nuids . '</div><br>
<span style="color:#64748b;font-size:12px;">voucher sedang dihapus</span>
