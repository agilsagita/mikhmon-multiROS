...
<?php 
  ...
  <div class="menu spa"></div>
  <a href="http://templatehotspot.com" target="_blank" class="menu partner-link"><i class="fa fa-wifi"></i> Template Hotspot</a>
  <a href="https://wa.me/628113028988?text=Halo%2C%20saya%20butuh%20jasa%20setting%20mikrotik" target="_blank" class="menu partner-link"><i class="fa fa-whatsapp"></i> Jasa Setting MikroTik</a>
  <a href="https://sebilling.com" target="_blank" class="menu partner-link"><i class="fa fa-credit-card"></i> Billing MikroTik</a>
  <a href="https://semesta.co.id" target="_blank" class="menu partner-link"><i class="fa fa-globe"></i> Jasa Buat Website</a>
