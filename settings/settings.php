    	   ...
    	   <div class="row">
            ...
            <div class="col-12">
				...
				<table class="table table-sm">
					...
					<tr>
						<td colspan="2">
							<div style="display: flex !important; align-items: center !important; gap: 8px !important; margin-top: 10px !important; width: 100% !important;">
								<input class="group-item group-item-md" type="submit" style="cursor: pointer; flex: 2 !important; height: 38px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;" name="save" value="Save"/>
								<span class="connect pointer group-item group-item-md pd-2p5 text-center align-middle" style="flex: 2 !important; height: 38px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;" id="<?= $session; ?>&c=settings">Connect</span>
								<span class="pointer group-item group-item-md pd-2p5 text-center align-middle" style="flex: 1.5 !important; height: 38px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;" id="ping_test">Ping</span>
								<div style="cursor: pointer; flex: 0.8 !important; height: 38px !important; display: inline-flex !important; align-items: center !important; justify-content: center !important;" class="group-item group-item-r pd-2p5 text-center" onclick="location.reload();" title="Reload Data"><i class="fa fa-refresh"></i></div>
							</div>
    					</td>
					</tr>
				</table>
